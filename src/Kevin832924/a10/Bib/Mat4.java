...
public final class Mat4 {
	...
	public Mat4(double m00, double m01, double m02, double m03, double m10,
	...
	/**
	 * Construct a new matrix from three basis Vec3s.
	 * 
	 * @param b0
	 *            The first basis Vec3.
	 * @param b1
	 *            The second basis Vec3.
	 * @param b2
	 *            The third basis Vec3.
	 */
	...
	public Vec3 transformPoint(Vec3 v) {
		final double x = get(0, 0) * v.x + get(1, 0) * v.y + get(2, 0) * v.z
				+ get(3, 0);
		final double y = get(0, 1) * v.x + get(1, 1) * v.y + get(2, 1) * v.z
				+ get(3, 1);
		final double z = get(0, 2) * v.x + get(1, 2) * v.y + get(2, 2) * v.z
				+ get(3, 2);
