...
public class Main {
	...
	public static void main(String[] args) {
		...
		Sphere s_two = new Sphere(new Point3(-3, -2, -6), 3.0, new LambertMaterial(new Color(20,100,0)));
		Sphere s_three = new Sphere(new Point3(-1, -5, -1), 1.6, new LambertMaterial(new Color(200,100,0)));
		Sphere s_four = new Sphere(new Point3(-2, -5, -7), 2.6, new LambertMaterial(new Color(0,100,220)));
		Sphere s_five = new Sphere(new Point3(-2, -2, 1), 1.8, new LambertMaterial(new Color(0,100,180)));
		Sphere s_six = new Sphere(new Point3(-2, 0, 0), 4.0, new LambertMaterial(new Color(0,150,180)));
		...
		lightlistDIR.add(new PointLight(new Color(200, 200, 200), new Point3(1,0,0), true));
