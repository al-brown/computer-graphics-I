...
import kevin832924.a06.Raytracer.Ray;
import kevin832924.a06.Bib.Point3;
...
public class PerspectiveCam {
	 ...
	 *            the angle of the camera
	 */
	public PerspectiveCam(final Point3 e, final Vec3 g, final Vec3 t, final double angle) {
		if (e == null) {
	...
	public PerspectiveCam zoomIn() {
		...
		double z = e.z - 1;
		if (x > 0 && y > 0 && z > 0) {
			return new PerspectiveCam(new Point3(e.x - 1, e.y - 1, e.z - 1), g, t, angle);
		} else {
			return this;
		}
	...
	public PerspectiveCam zoomOut() {
		...
		double y = e.y + 1;
		double z = e.z + 1;
		return new PerspectiveCam(new Point3(x, y, z), g, t, angle);
