...
import kevin832924.b04.Bib.Image;
import kevin832924.b04.Bib.Point3;
import kevin832924.b04.Bib.Vec3;
import kevin832924.b04.Cameras.PhotoSphereCam;
import kevin832924.b04.Light.DirectionalLight;
import kevin832924.b04.Light.Light;
import kevin832924.b04.Material.LambertMaterial;
import kevin832924.b04.Material.OrenNayarMaterial;
import kevin832924.b04.Shape.Shape;
import kevin832924.b04.Shape.Sphere;

public class Main {

	static String name = "doc/b04-7.png";
	...
	public static void main(String[] args) {
		...
		PhotoSphereCam cam = new PhotoSphereCam(new Point3(0, 0, 0), new Vec3(0, 0, -1), new Vec3(0, 1, 0) );
	...
	private static BufferedImage raytrace(Group group, PhotoSphereCam cam, int rate) {
